...
In general, we can see that all variables are significant in our model. However, both the deviance 8654.6 and Pearson statistic 11064.29 are larger than Chi-Square(1666)  1762.07 which indicates a poor fit.
...
```
Based on F-test, all variables are significant here and can be included in our model.
...
```
We can see the AIC of negative binomial model is much smaller than poisson model.
