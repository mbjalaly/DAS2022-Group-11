...
```
We can see the deviance of negative binomial model is much smaller than the poisson one, and as for AIC, both model are equal. As for the deviance ratio, we could see that 1.178912 is smaller than 1.5, so negative binomial model fit our data better.
