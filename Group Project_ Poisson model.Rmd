...
(Here put the binomial model A)
In this model,except for(here put those three variables), all others are significant. Let's take animal_type as an example, dog's odds of staying at shelter
...
Another model is:
(Here put the negative binomial model B)
Compared with model A, (Here put those four variables) are not significant anymore. It means these variables impact whether or not animals will stay at shelter, but they don't impact how many days they will stay at shelter.
