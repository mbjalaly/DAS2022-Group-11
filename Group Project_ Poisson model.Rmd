...
$$ \widehat{\mbox{Time_at_shelter}} = 7.8792+0.8581 ~ Animal\_type\_DOG-4.7983 ~ Owner\_urrender\_SURRENDER_1 ~ -3.7933 ~ intake\_type\_STRAY -1.0526 ~ chip\_status\_UNABLE\_TO\_SCAN-2.3051~ outcome\_type\_DIED - 3.5892~outcome\_type\_EUTHANIZED -2.7973 ~ outcome\_typeFOSTER- 4.7999 ~ outcome\_type\_RETURNED\_TO\_OWNER $$
...
Another model is:
$$ \widehat{\mbox{Time_at_shelter}} = 3.18537-1.35700 ~ Owner\_urrender\_SURRENDER_1~ -0.91826 ~ intake\_type\_STRAY -0.32018 ~ outcome\_type\_EUTHANIZED -1.14834~outcome\_type\_RETURNED\_TO\_OWNER $$
...
$$\frac{OTHER\_TYPES}{CATS}=exp(0.31221)$$
