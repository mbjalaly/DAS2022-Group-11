...
From summary, we could see that except outcome_typeFOSTER, all other variables are significant in our model. However, both the deviance 8883.7 and pearson statistic 11632.76 are larger than Chi-Square(1667) 1763.099 which indicate a poor fit.
...
Build a new model without chip_status.
```{r}
