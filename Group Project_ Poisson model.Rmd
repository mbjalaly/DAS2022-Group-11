...
```{r}
animals.glm.nb=glm.nb(time_at_shelter~animal_type + intake_type + chip_status, data=animals.cleaned)
summary(animals.glm.nb)
```
compare the poisson model and negative binomial model
```{r}
#poisson
c(animals.glm$deviance,animals.glm$aic)
#negative binomial model
c(animals.glm.nb$deviance,animals.glm.nb$aic)
```
We can see the deviance and AIC of negative binomial model are smaller than poisson model.
